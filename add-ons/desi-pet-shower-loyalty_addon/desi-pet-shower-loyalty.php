...
add_action( 'init', 'dps_loyalty_load_textdomain', 5 );
...
if ( ! function_exists( 'dps_loyalty_init' ) ) {
     ...
     * Usa prioridade 20 para rodar após o carregamento do text domain (prioridade 5).
     */
...
add_action( 'init', 'dps_loyalty_init', 20 );
