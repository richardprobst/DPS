<?php
/**
 * Rotina de desinstalação do plugin Desi Pet Shower - Services Add-on
 *
...
$wpdb->query(
    "DELETE FROM {$wpdb->options} 
     WHERE option_name LIKE '_transient_dps_service%' 
     OR option_name LIKE '_transient_timeout_dps_service%'"
);
