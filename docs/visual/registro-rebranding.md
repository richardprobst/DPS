...
| 4 | Cadastro e formulários compartilhados | `desi-pet-shower-base`, `desi-pet-shower-registration` | `assets/css/dps-signature-forms.css` e módulos relacionados | Ativo | 2026-04-21 | Consolidação do motor visual compartilhado dos fluxos de cadastro, portal e formulários internos. O add-on `desi-pet-shower-frontend` foi removido e não é fonte ativa deste registro. |
