...
- **Ambiente:** Preview HTML estÃ¡tico com CSS do design system DPS Signature (dps-design-tokens.css + checklist-checkin.css). Sem WordPress runtime.
...
- `./checklist-progress-67pct.png` â€” CenÃ¡rio 2: Checklist com 67% de conclusÃ£o, mostrando etapas concluÃ­das (riscadas), uma etapa pulada, e badge de retrabalho (ðŸ”„ 1) na etapa "Secagem"
...
### ðŸ—‚ï¸ Indicadores Compactos (Cards de Agendamento)
- `./compact-card-in-progress.png` â€” CenÃ¡rio 7: Card do Rex com checklist 67%, badge de retrabalho, check-in feito (ðŸ“¥) e alertas de seguranÃ§a inline
