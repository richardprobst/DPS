...
O **Backup & Restauração Add-on** permite exportar e restaurar dados completos do sistema Desi Pet Shower em formato JSON. É uma ferramenta crítica para migrações, recuperação de desastres e manutenção do sistema.
...
│ atuais do Desi Pet Shower. Esta operação não pode ser   │
│ desfeita.                                               │
│                                                         │
