...
Este documento descreve todas as APIs implementadas no sistema desi.pet by PRObst (DPS), seus propósitos, métodos públicos, endpoints AJAX e endpoints REST.
