...
2026-03-07
- Lido o estado atual da Fase 1, auditoria do add-on e diretrizes DPS Signature em docs/visual/.
...
- Referencia DPS Signature aplicada explicitamente a partir de `docs/visual/FRONTEND_DESIGN_INSTRUCTIONS.md` e `docs/visual/VISUAL_STYLE_GUIDE.md`.
...
- Canvas e CSS ganharam detalhes de espuma, bolhas, marcas de pata e acentos mais proximos da paleta DPS, seguindo `docs/visual/` como fonte de verdade do padrao DPS Signature.
