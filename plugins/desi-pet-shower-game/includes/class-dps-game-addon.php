                    ...
                    <div class="dps-sg-overlay__content">
                        ...
                        <div class="dps-sg-overlay__result-grid">
                            <div class="dps-sg-overlay__result-card">
                                ...
                                <strong class="dps-sg-result-combo">0</strong>
                            </div>
                            <div class="dps-sg-overlay__result-card">
                                <span class="dps-sg-overlay__result-label"><?php echo esc_html__( 'Onda', 'dps-game' ); ?></span>
                                <strong class="dps-sg-result-wave">1</strong>
                            </div>
                            <div class="dps-sg-overlay__result-card">
                                <span class="dps-sg-overlay__result-label"><?php echo esc_html__( 'Tempo', 'dps-game' ); ?></span>
                                <strong class="dps-sg-result-time">0s</strong>
                            </div>
                        </div>
