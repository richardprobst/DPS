...
Este guia explica como configurar o campo "Webhook secret" nas Configurações de Pagamentos do desi.pet by PRObst e como configurar o webhook no painel do Mercado Pago.
...
2. Vá em **desi.pet by PRObst > Pagamentos**
