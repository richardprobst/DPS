...
class DPS_GitHub_Updater {
    ...
    private function register_plugins() {
        $this->plugins = array(
            // Plugin Base
            'desi-pet-shower-base/desi-pet-shower-base.php' => array(
                'name'        => 'desi.pet by PRObst – Base',
                'repo_path'   => 'plugins/desi-pet-shower-base',
                'slug'        => 'desi-pet-shower-base',
            ),
            // Add-ons
            'desi-pet-shower-agenda/desi-pet-shower-agenda-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Agenda Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-agenda',
                'slug'        => 'desi-pet-shower-agenda',
            ),
            'desi-pet-shower-ai/desi-pet-shower-ai-addon.php' => array(
                'name'        => 'desi.pet by PRObst – AI Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-ai',
                'slug'        => 'desi-pet-shower-ai',
            ),
            'desi-pet-shower-backup/desi-pet-shower-backup-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Backup Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-backup',
                'slug'        => 'desi-pet-shower-backup',
            ),
            'desi-pet-shower-client-portal/desi-pet-shower-client-portal.php' => array(
                'name'        => 'desi.pet by PRObst – Client Portal Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-client-portal',
                'slug'        => 'desi-pet-shower-client-portal',
            ),
            'desi-pet-shower-communications/desi-pet-shower-communications-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Communications Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-communications',
                'slug'        => 'desi-pet-shower-communications',
            ),
            'desi-pet-shower-finance/desi-pet-shower-finance-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Financeiro Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-finance',
                'slug'        => 'desi-pet-shower-finance',
            ),
            'desi-pet-shower-groomers/desi-pet-shower-groomers-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Groomers Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-groomers',
                'slug'        => 'desi-pet-shower-groomers',
            ),
            'desi-pet-shower-loyalty/desi-pet-shower-loyalty.php' => array(
                'name'        => 'desi.pet by PRObst – Loyalty Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-loyalty',
                'slug'        => 'desi-pet-shower-loyalty',
            ),
            'desi-pet-shower-payment/desi-pet-shower-payment-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Payment Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-payment',
                'slug'        => 'desi-pet-shower-payment',
            ),
            'desi-pet-shower-push/desi-pet-shower-push-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Push Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-push',
                'slug'        => 'desi-pet-shower-push',
            ),
            'desi-pet-shower-registration/desi-pet-shower-registration-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Registration Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-registration',
                'slug'        => 'desi-pet-shower-registration',
            ),
            'desi-pet-shower-services/desi-pet-shower-services.php' => array(
                'name'        => 'desi.pet by PRObst – Services Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-services',
                'slug'        => 'desi-pet-shower-services',
            ),
            'desi-pet-shower-stats/desi-pet-shower-stats-addon.php' => array(
                'name'        => 'desi.pet by PRObst – Stats Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-stats',
                'slug'        => 'desi-pet-shower-stats',
            ),
            'desi-pet-shower-stock/desi-pet-shower-stock.php' => array(
                'name'        => 'desi.pet by PRObst – Stock Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-stock',
                'slug'        => 'desi-pet-shower-stock',
            ),
            'desi-pet-shower-subscription/desi-pet-shower-subscription.php' => array(
                'name'        => 'desi.pet by PRObst – Subscription Add-on',
                'repo_path'   => 'plugins/desi-pet-shower-subscription',
                'slug'        => 'desi-pet-shower-subscription',
            ),
        );
    }
