...
O Portal do Cliente do desi.pet by PRObst (DPS) agora utiliza um sistema moderno de autenticação baseado em **links com token (magic links)**, eliminando completamente a necessidade de senhas fixas.
...
Este add-on faz parte do desi.pet by PRObst (DPS) e segue a mesma licença do projeto principal.
